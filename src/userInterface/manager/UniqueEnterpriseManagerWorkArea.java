 ...
 * @author nishi
 */
public class UniqueEnterpriseManagerWorkArea extends javax.swing.JPanel {
   ...
   private VolunteerOrganization vo;
    ...
    private HelpNeededOrganization hsOrg;
     ...
     * 
     */
    public UniqueEnterpriseManagerWorkArea(JPanel userProcessContainer, Enterprise enterprise, EcoSystem ecoSystem, UserAccount userAccount) {
        initComponents();
    ...
    private void initComponents() {
        ...
        manageEnt1.setText("Unique Manager Work Area");
    ...
    public void populatePieChartData()
    {
       ...
       for(Organization organization : enterprise.getOrganizationDirectory().getOrganizationList())
       {
          ...
          {
          this.hsOrg = (HelpNeededOrganization)organization;   
