...
public class ManageNetworkJPanel extends javax.swing.JPanel {
    ...
    private void countryComboBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_countryComboBoxActionPerformed
        ...
        {
        statesComboBox.addItem("Madhya Pradesh");
    ...
    private void statesComboBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_statesComboBoxActionPerformed
        ...
        {
        cityComboBox.addItem("Albany");
        cityComboBox.addItem("NYC");    
        }
        else if(statesComboBox.getSelectedItem() == "Madhya Pradesh")
        {
         cityComboBox.addItem("Indore");
        }
        else if(statesComboBox.getSelectedItem() == "Gujrat")
        {
        cityComboBox.addItem("Vadodara");
        cityComboBox.addItem("Ahemdabad");    
        }
