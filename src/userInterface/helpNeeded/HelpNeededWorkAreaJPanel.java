...
import userInterface.sensorPckg.ManageHelpNeededProfileJPanel;

/**
 *
 * @author nishi
 */
public class HelpNeededWorkAreaJPanel extends javax.swing.JPanel {
     ...
     */
    public HelpNeededWorkAreaJPanel(JPanel userProcessContainer, Enterprise enterprise , UserAccount userAccount, EcoSystem ecoSystem) {
        initComponents();
      ...
      alertsPanel.revalidate();
       ...
       int pos = 0;
         boolean flag = false;
            if(patientCond)
            {
            txtField = new JTextField("Alert Message From Unique!");   
    ...
    private void initComponents() {
        ...
        manageEnt.setText("Help Needed Work Area");
    ...
    private void manageHelpSeekerProfileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_manageHelpSeekerProfileActionPerformed
        ManageHelpNeededProfileJPanel manageHelpSeekerProfileJPanel = new ManageHelpNeededProfileJPanel(userProcessContainer, userAccount, enterprise, ecoSystem);
